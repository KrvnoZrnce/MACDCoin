...
void BitcoinGUI::createMenuBar()
{
    ...
    //widgetMenuBar = new QMenuBar();

    //QString ss("QMenuBar::item { background-color: rgba(1,1,1,0); color: white }");
    //appMenuBar->setStyleSheet(ss);

    //addWidget(appMenuBar);
}
