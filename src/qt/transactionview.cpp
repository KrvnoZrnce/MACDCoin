...
QWidget *TransactionView::createDateRangeWidget()
{
    ...
    dateFrom->setMinimumWidth(300);
    dateFrom->setDate(QDate::currentDate().addDays(-7));
    dateFrom->setStyleSheet("QDateTimeEdit{color:white; background-color:rgba(37, 170, 225, 255); border-color:rgba(37, 170, 225, 255); border-style:solid; border-width:1px;}");
    ...
    dateTo->setMinimumWidth(300);
    dateTo->setDate(QDate::currentDate());
    dateTo->setStyleSheet("QDateTimeEdit{color:white;background-color:rgba(37, 170, 225, 255);border-color:rgba(37, 170, 225, 255); border-style:solid; border-width:1px;}");
